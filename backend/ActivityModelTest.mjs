...
/**
 * ActivityModel Test Script
 *
 * This file is used to test the functionality of the ActivityModel.
 *
 * It verifies that:
 * - Activities can be created successfully
 * - Activities can be retrieved by ID
 * - Data stored in the database matches expected values
 *
 * This follows a simple assertion-based testing approach similar to manual unit testing.
 */

import { ActivityModel } from "./models/ActivityModel.mjs";

// Simple test function (same idea as sample)


/**
 * Compares expected and actual values and prints test result.
 *
 * @param {any} expected - Expected value
 * @param {any} actual - Actual value returned from function
...
// Use YOUR method
const insertId = await ActivityModel.createActivity(name, description, status);

// Fetch inserted record
const loadedActivity = await ActivityModel.findById(insertId);

// Test result
test(
  description,
  loadedActivity.description,
  "Check that createActivity and findById work correctly"
);